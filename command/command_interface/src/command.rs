...
mod test
{
   ...
   fn test_ls()
   {
        ...
        let comp_vec = vec!["Cargo.lock", "Cargo.toml", "file.txt", "main.exe", "main.pdb", "\x1b[1;34msrc\x1b[0m", "\x1b[1;34mtarget\x1b[0m", "\x1b[1;34mtest\x1b[0m", "\x1b[1;34mversions\x1b[0m"];
        assert_eq!(path_vec, comp_vec);

        let option: String = "-a".to_string();
        let path: &str = "";
        let path_vec: Vec<String> = ls(option, path);
        let comp_vec = vec!["\x1b[1;34m.git\x1b[0m", ".gitignore", "Cargo.lock", "Cargo.toml", "file.txt", "main.exe", "main.pdb", "\x1b[1;34msrc\x1b[0m", "\x1b[1;34mtarget\x1b[0m", "\x1b[1;34mtest\x1b[0m", "\x1b[1;34mversions\x1b[0m"];
        assert_eq!(path_vec, comp_vec);
        ...
        let path: &str = "";
        let path_vec: Vec<String> = ls(option, path);
        let comp_vec = vec!["\x1b[1;34m.git\x1b[0m", "\x1b[1;34msrc\x1b[0m", "\x1b[1;34mtarget\x1b[0m", "\x1b[1;34mtest\x1b[0m", "\x1b[1;34mversions\x1b[0m"];
        assert_eq!(path_vec, comp_vec);
